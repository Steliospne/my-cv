    ...
    <main className="h-screen overflow-hidden px-4 py-4 md:px-6 md:py-6">
      <div className="mx-auto flex h-full max-w-[1450px] flex-col gap-3">
        <div className="shrink-0">
          <Link
            href="/"
            className="inline-flex rounded-full border border-[var(--line)] bg-[var(--panel)] px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-[var(--muted-strong)] transition hover:border-[var(--accent)] hover:text-[var(--ink)]"
          >
            Back To Dashboard
          </Link>
        </div>
