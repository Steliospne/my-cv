...
export async function serializeCv(cvId: string): Promise<CvDocument | null> {
...
export async function createCv(): Promise<CvDocument> {
...
export async function ensureCv(): Promise<CvDocument> {
