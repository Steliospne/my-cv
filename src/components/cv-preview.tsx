  ...
  return (
    <section className="a4-sheet mx-auto">
      ...
      <section className="mt-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--ink-soft)]">{cv.summary}</p>
      </section>
              ...
              <article key={item.id} className="space-y-1">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    {item.subtitle && (
                      <p className="text-sm text-[var(--muted-strong)]">{item.subtitle}</p>
                    )}
                  </div>
                  {item.period && (
                ...
                {splitDetails(item.details).length > 0 && (
                  <ul className="mt-1 space-y-1 text-sm leading-6 text-[var(--ink-soft)]">
